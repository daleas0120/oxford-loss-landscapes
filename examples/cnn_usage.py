...
print(" ---> IMPORTANT NOTE: This example requires downloading the ImageNet-1k dataset (about 15GB).")
print(" ---> If you do not have access to this dataset, please skip this example.")
print(" ---> To get access, you need to register at hugging face: https://huggingface.co/datasets/imagenet-1k")
...
try:
    ...
    try:
        ...
        model_path = 'vgg16_loss_landscape_example.png'
    ...
    try:
        ...
        plt.savefig('vgg16_loss_landscape_2d_example.png', dpi=150, bbox_inches='tight')
        plt.show()
        plt.close()
        print("   Saved 2D loss landscape plot to 'vgg16_loss_landscape_2d_example.png'")
